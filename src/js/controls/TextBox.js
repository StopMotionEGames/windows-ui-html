...
export default class TextBox extends HTMLElement {
  ...
  #UpdateEnabledState() {
    this.txtbox.disabled = !this.IsEnabled;
  }
  /** Updates the size of the wuhc-textbox based on `width` and `height` */
  #UpdateSizes() {
    if (this.Width === "auto")
  ...
  #InitializeControl() {
    this.txtbox.type = "text";
    this.appendChild(this.txtbox);
    this.#UpdateSizes();
    if (debug)
      console.log(
